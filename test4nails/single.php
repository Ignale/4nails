                ...
                <div class="article__content">
                    ...
                    <div class="article__main">
                        ...
                        <div class="article__like">
                            <iframe src="https://www.facebook.com/plugins/like.php?href=<?= the_permalink(); ?>%2F&width=450&layout=standard&action=like&size=small&share=false&height=35&appId"
                        ...
                        <div class="article__share">
                            ...
                            <div class="article__share-links shareon" data-url="<?php the_permalink() ?>">
                                <a class="facebook"></a>
                                <a class="linkedin"></a>
                                <a class="pinterest"></a>
                    ...
                    <aside class="sidebar">
                        ...
                        <div class="follow-us sidebar__item">
                            ...
                            <div class="follow-us__content">
                                <iframe src="https://www.facebook.com/plugins/page.php?href=<?= get_field('facebook_link','options')?>&tabs=timeline&width=231&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=1234367356961387",
                                        width="231" adapt_container_width="true" height="500"
                        ...
                        <div class="youtube blog-youtube">
                            ...
                            <div class="youtube__item">
                                <?php if (have_rows('blog_videos')): ?>
                                    <?php while (have_rows('blog_videos')): the_row(); ?>
                                        <div class="youtube__item">
                            ...
                            <div class="youtube__subscribe">
                                ...
                                <div class="g-ytsubscribe" data-channelid="UCYRw15Xypbn4nILXNe4KSTw" data-layout="full" data-count="default" data-width="200px"></div>
                            </div>
