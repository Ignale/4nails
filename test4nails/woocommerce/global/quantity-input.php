...
<div class="product__quantity quantity">
  ...
  >
    ...
    width="22px"
    height="22px"
    viewBox="-164.5 181.5 22 22"
    enable-background="new -164.5 181.5 22 22"
    xml:space="preserve"
    >
      <path
      fill="#17CFB9"
      d="M-153.5,181.5c-6.075,0-11,4.925-11,11c0,6.074,4.925,11,11,11c6.075,0,11-4.926,11-11
  ...
  size="4"
  <?php echo esc_attr(join(' ', (array) $classes)); ?>
  />
  <button
  class="product__plus qty-btn"
  type="button"
  <?php echo esc_attr(join(' ', (array) $classes)); ?>
  >
    <svg
    ...
    >
      ...
      clip-rule="evenodd"
      fill="#17CFB9"
      d="M-153.5,181.5c-6.075,0-11,4.925-11,11c0,6.074,4.925,11,11,11
