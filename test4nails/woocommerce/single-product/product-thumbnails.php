...
<div class="swiper-wrapper">
  <a
    data-count="<?= $count ?>"
    class="swiper-slide product__slide product-image copyright"
    data-thumbImage="<?=$temp?>"
    data-bigImage="<?=$temp?>"
  >
    <img
      <?= wp_is_mobile()?'data-fancybox="gallery"':''?>
      src="<?=$temp?>"
      data-src="<?= $temp ?>"
    >
  </a>
...
<div class="swiper-wrapper">
  ...
  <a
    data-count="<?= $count ?>"
    class="swiper-slide product__slide product-image copyright"
    data-thumbImage="<?=$imageThumbnail?>"
    data-bigImage="<?=$imageBig?>"
  >
    <img
      <?= wp_is_mobile()?'data-fancybox="gallery"':''?>
      src="<?=$imageThumbnail?>"
