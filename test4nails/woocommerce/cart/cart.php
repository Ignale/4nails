    ...
    <div class="cart__new-container">
      ...
      <div class="cart__product-wrapper woocommerce-cart-form__contents">
        ...
        foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item):
          ...
          if (count(wc_get_notices('error')) > 0) {

            ob_start();

            get_template_part('widgets/product/quantity', 'modal', ['product' => $_product->get_data(), 'button_text' => 'Back to cart']);
        ...
        <div class="cart__product woocommerce-cart-form__cart-item">
          ...
          <div class="cart__product-info">
            ...
            <div
              ...
              data-stock-status="<?= $cart_item['data']->stock_status ?>"
            ...
            >
              ...
              <div
                ...
                class="tooltip"
              >
                <?= sprintf(__('Sorry, we do not have more "%s" in stock (%s available). We apologize for any inconvenience caused.', '4nails'), $_product->get_name(), $_product->get_stock_quantity()) ?>
              </div>
