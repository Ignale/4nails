...
foreach ($order->get_shipping_methods() as $shipping_method) {
  $method = $shipping_method->get_method_id();
}
...
<?php if ($method === 'overweight_shipping' && !$sent_to_admin) { ?>
  <table>
    <tr>
      <td>
        <h3>
          <?php echo get_field('separate_invoice_title', 'options') ?>
        </h3>
        <p>
          <?php echo get_field('separate_invoice_text', 'options') ?>
        </p>
      </td>
    </tr>
  </table>
