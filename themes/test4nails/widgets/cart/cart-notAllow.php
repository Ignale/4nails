      ...
      <div class="modal-body">
        <div class="modal-error">
          ...
          <div class="modal-error__header">
            <?= __("The first items must be ordered separately. The remaining items on the list can be combined into one order.", '4nails') ?>
          </div>
          ...
          <div class="modal-error__wrap">
            ...
            <div class="modal-error__second">
              ...
              <div class="show-more">
                ...
                onclick="window.location.href='#firstItem'"
                >
            ...
            <div class="modal-error__buttons">
              ...
              <div
              class="modal-error__go-shop red-btn"
              id="backToCart"
              ><?= __('Back to cart', '4nails'); ?></div>
